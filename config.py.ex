...
ICAL_FEEDS=[
    #INP2A
    #{'download': '/Users/xxx/Downloads','url': 'none','source': cfg.ICAL_FEED, 'destination': 'xx@group.calendar.google.com', 'files': False, 'school': 'INP'}
    #,
    # ENAC
    #{'download': '/Users/xx/Downloads','url': 'https://xxx','source': '/Users/xxx/Documents/GitHub/edt_to_gcal_sync_grenoble_inp/ics', 'destination': 'xxx@group.calendar.google.com', 'files': True, 'school': 'ENAC'}
    #INP
    #{'download': '/Users/xx/Downloads','url': 'none','source': cfg.ICAL_FEED, 'destination': 'xxx@group.calendar.google.com', 'files': False, 'school': 'INP'}
    #,
    #Test ENAC
    {'download': '/Users/xx/Downloads','url': 'https://xxx', 'source': '/Users/xxx/Documents/GitHub/edt_to_gcal_sync_grenoble_inp/ics', 'destination': 'xxx@group.calendar.google.com', 'files': True, 'school': 'ENAC'}
    ]
